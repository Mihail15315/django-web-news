...
## Импорт Примечательных мест из xlsx-файла
- **Перейдите на адрес http://localhost:8000/upload/**: Добавьте xlsx-файл ![Пример как должен выглядеть файл](https://github.com/Mihail15315/django-web-news/blob/Place/places.png) при этом заметьте что все ячейки текстовые, кроме рейтинга там числовые
- **Просмотр и редактирование Примечательных мест в админке, координаты получать с
помощью виджета карты**: Перейдите на адрес http://localhost:8000/admin/news/notableplace/ и здесь вы можете добавить/изменить/удалить и поставить рейтинг любому месту используя карту и значок маркера для проставления координаты.
### Страница админки Примечательных мест
![](https://github.com/Mihail15315/django-web-news/blob/Place/place.png)
